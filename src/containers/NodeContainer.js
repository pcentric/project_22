...
class NodeContainer extends Component {
  ...
  render() {
    ...
    return (
      <div
        className={"node-container " + hasChildrenClass}
        key={id}
      ...
      >
        ...
        <PlaceholderNode visible={isOver} />
          <NodeList parentId={id}>{children}</NodeList>
...
const NodeContainerTarget = {
  ...
  canDrop: function (props, monitor) {
    ...
    if (
      dropItem.id === props.id ||
      props.id === dropItem.fromParent ||
      props.isDescendant(dropItem.id)
    )
      return false;
